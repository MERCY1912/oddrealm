    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <Card className="w-full max-w-md bg-gradient-to-br from-gray-900 to-black border-2 border-red-500/30 shadow-2xl">
        ...
        <CardHeader className="text-center pb-4">
          ...
          <p className="text-gray-400 text-sm">Войдите в мир жестокости и темной магии</p>
        </CardHeader>
          ...
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="login" className="space-y-4 mt-6">
              <form onSubmit={handleAuth} className="space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-red-600 to-red-800 hover:from-red-700 hover:to-red-900 text-white font-bold py-3"
                  disabled={loading}
                >
            ...
            <TabsContent value="register" className="space-y-4 mt-6">
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="reg-username" className="text-white font-semibold">
                    Имя воина
                  </Label>
                  <Input
                    id="reg-username"
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <div className={`p-2 rounded-lg ${cls.bgColor} ${cls.borderColor} border`}>
                              <Icon className={`h-5 w-5 ${cls.color}`} />
                            </div>
                            <div className="flex-1">
                              <div className={`font-bold ${cls.color}`}>
                                {cls.emoji} {cls.name}
                              </div>
